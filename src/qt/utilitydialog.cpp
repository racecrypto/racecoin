    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Race Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Race Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  race-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Race in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RACE, 0.1 RACE, 1 RACE and 10 RACE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Race Core is shutting down...") + "<br /><br />" +
