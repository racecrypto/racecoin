    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Race Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Race address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and race: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Race Core"), this);
    aboutAction->setStatusTip(tr("Show information about Race Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Race Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Race addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Race addresses"));
    ...
    openAction->setStatusTip(tr("Open a race: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Race Core help message to get a list with possible Race Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Race Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Race network", "", count));
    } else {
...
{
    QString strTitle = tr("Race Core"); // default title
