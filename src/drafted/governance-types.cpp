...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RaceNetwork") type = RaceNetwork;
    if(strType == "RaceNetworkVariable") type = RaceNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RaceNetwork) s = "RaceNetwork";
    if(type == RaceNetworkVariable) s = "RaceNetworkVariable";
