 ...
 *
 *   // network
 *   CRaceNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CRaceNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RaceNetwork
// //   -- signature requirements : Key1(User)
// class CRaceNetworkVariable : public CGovernanceObject
// {
// private:
