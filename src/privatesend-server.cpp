...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Race related functionality
...
/*
    ...
    allow endless transaction that would bloat Race and make it unusable. To
