...
Only requiring some minor changes is race.cpp.
...
Changes to race.cpp
----------------------
race.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
